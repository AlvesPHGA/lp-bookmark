...
export const features = tv({
   slots: {
      feature: 'py-44 relative lg:pt-24 lg:pb-32 md:pt-10 ml:pb-20',
      container:
...
export const featuresTab = tv({
   slots: {
      ...
      content_box:
         'pr-20 flex flex-col justify-center gap-5 lg:pr-16 md:pr-0 ml:text-center ml:w-80 ml:mx-auto items-center',
   },
});

export const tab = tv({
   base: 'py-6 px-12 font-medium text-base text-slate-500 hover:text-red-500 transition relative ml:border-b ml:w-full ml:px-0 ml:block',
...
export const imageBox = tv({
   slots: {
      box: 'w-[50rem] h-[37.5rem] first:h-[25rem] lg:w-[440px] lg:first:h-[320px] lg:h-[380px] md:w-80 md:first:h-60 md:h-52 ml:w-80 ml:mx-auto ml:h-fit',
